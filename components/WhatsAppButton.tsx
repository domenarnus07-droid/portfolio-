    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="group fixed bottom-6 left-5 z-[70] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 sm:bottom-8 sm:left-6"
        >
          {/* utripajoč obroč */}
