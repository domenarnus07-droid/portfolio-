      ...
      <AnimatePresence>
        {(visible || open) && (
          <motion.button
            ...
            className="fixed bottom-6 right-5 z-[95] flex h-14 w-14 items-center justify-center rounded-full bg-primary text-white shadow-lg shadow-primary/30 hover:scale-105 sm:bottom-8 sm:right-6"
          >
            {open ? (
